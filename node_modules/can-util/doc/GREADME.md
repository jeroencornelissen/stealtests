...
- _can-util/dom_
  - <code>[__can-util/dom/ajax/ajax__ function](#can-utildomajaxajax-function)</code>
    - <code>[ajax( ajaxOptions )](#ajax-ajaxoptions-)</code>
  ...
  - <code>[__can-util/dom/data/data__ Object](#can-utildomdatadata-object)</code>
    ...
    - <code>[domData.set.call(el, name, value)](#domdatasetcallel-name-value)</code>
  ...
  - <code>[__can-util/dom/events/events__ Object](#can-utildomeventsevents-object)</code>
    ...
    - <code>[__can-util/dom/events/make-mutation-event/make-mutation-event__ function](#can-utildomeventsmake-mutation-eventmake-mutation-event-function)</code>
      - <code>[makeMutationEvent(specialEventName, mutationNodesProperty)](#makemutationeventspecialeventname-mutationnodesproperty)</code>
...
- _can-util/js_
  ...
  - <code>[__can-util/js/diff/diff__ function](#can-utiljsdiffdiff-function)</code>
    - <code>[diff( oldList, newList, [identity] )](#diff-oldlist-newlist-identity-)</code>
  ...
  - <code>[__can-util/js/make-array/make-array__ function](#can-utiljsmake-arraymake-array-function)</code>
    - <code>[makeArray(element)](#makearrayelement)</code>
  - 
...
1. __ajaxOptions__ <code>{Object}</code>:
...
Remove data from an element previously added by [set](#domdatasetcallel-name-value)
...
### <code>domData.set.call(el, name, value)</code>
...
#### <code>makeMutationEvent(specialEventName, mutationNodesProperty)</code>
...
### <code>diff( oldList, newList, [identity] )</code>
...
1. __identity__ <code>{function}</code>:
  an optional identity function for comparing elements
...
- __returns__ <code>{Object|ArrayLike}</code>:
...
### <code>makeArray(element)</code>


1. __element__ <code>{ArrayLike|Object}</code>:
  any array-like or object data structure
